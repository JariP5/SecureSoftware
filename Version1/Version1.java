...
public class Version1 {
    ...
    private static void menuWhenLoggedIn(User user) {
        ...
        while (inMenu) {
            // User choices
            System.out.println("1. Create file for your sensitive data.");
            ...
            if (choice == 1) {
                String userInput = cnsl.readLine("You may update your file...\n ");
                String userFileName = user.getEmail() + ".txt";
                try (FileWriter writer = new FileWriter(userFileName)) {
                    writer.write(userInput);
                    System.out.println("You have succesfully updated your file.");
                } catch (IOException e) {
                    System.out.println("Error: User cannot update file right now.");
                }
    ...
    private static User createUser() {
        ...
        while (gettingEmail) { // get email from user
            ...
            if (email.length() == 1 && email.contains("b")) {
                ...
                if (email.charAt(0) == '@' || !email.contains("@") || email.length() < 8 || !email.contains(".") ) {
